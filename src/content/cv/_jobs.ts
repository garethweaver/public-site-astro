...
export const jobsList: JobList[] = [
  {
    title: "Upgrowth",
    meta: ["Senior Fullstack", "Digital Agency", "Next"],
    date: {
      from: "OCT24",
      to: "NOW",
    },
    body: "<p>Joined as a senior fullstack engineer placed inside BigW working on their online ecomm store. Responsible for the development of features within the BigW storefront NextJS application and pipeline that is used by half a million Australians every day.<p>",
  },
  {
    title: "Wonderbly",
    meta: ["Lead Frontend", "Publisher", "Astro"],
    date: {
      from: "OCT21",
      to: "JAN24",
      duration: "2Y02M",
  ...
  {
    title: "Wonderbly",
    meta: ["Senior Frontend", "Publisher", "React"],
    date: {
      from: "MAR20",
      to: "OCT21",
      duration: "1Y08M",
  ...
  },
  {
    ...
    meta: ["Contract", "Logistics Startup", "Nuxt"],
    date: {
      from: "OCT19",
      to: "DEC19",
      duration: "0Y03M",
  ...
  {
    title: "Nexus Studios",
    meta: ["Contract", "Creative Agency", "Gatsby", "Vue"],
    date: {
      from: "AUG19",
      to: "OCT19",
      duration: "0Y03M",
  ...
  },
  {
    ...
    meta: ["Personal Project", "React", "Node", "Firebase"],
    date: {
      from: "JUN19",
      to: "JUL19|SEP24",
      duration: "0Y02M",
  ...
  {
    title: "Kortical",
    meta: ["Contract", "ML Accelerator", "Gatsby"],
    date: {
      from: "FEB19",
      to: "JUN19",
      duration: "0Y05M",
  ...
  },
  {
    ...
    meta: ["Contract", "Comms Agency", "Vue"],
    date: {
      from: "NOV18",
      to: "JAN19",
      duration: "0Y02M",
  ...
  },
  {
    ...
    meta: ["Contract", "Business Consultancy", "Angular"],
    date: {
      from: "MAR17",
      to: "JUL18",
      duration: "1Y04M",
  ...
  {
    title: "Big Sofa",
    meta: ["Frontend Engineer", "Digital Media Company", "Angular"],
    date: {
      from: "SEP14",
      to: "AUG16",
      duration: "1Y11M",
  ...
  {
    title: "Big Sofa",
    meta: ["Contract", "Digital Media Company"],
    date: {
      from: "JUN14",
      to: "SEP14",
      duration: "0Y03M",
  ...
  {
    title: "Selfridges & Co",
    meta: ["Contract", "Online Retailer"],
    date: {
      from: "MAY14",
      to: "JUN14",
      duration: "0Y01M",
    },
    body: "<p>A three week contract placed within Selfridges’ online team. I worked closely with the design team to construct markup for the online store and website. I was also tasked with the templating and testing of marketing emails.</p>",
  },
  {
    title: "Yello Studio",
    meta: ["Fullstack Developer", "Creative Agency"],
    date: {
      from: "JAN11",
      to: "SEP13",
      duration: "2Y09M",
    },
    body: '<p>Worked as a key member of <a href="http://www.yellostudio.co.uk/" target="_blank">the studio</a> supporting both the technical and creative directors while also handling agency clients. I worked independently and collaboratively on larger projects providing UI solutions as well as attending client meetings, managing clients and delivering training. My role covered bespoke design, frontend development and back-end development, CMS integration, email marketing and analytics.</p>',
  },
];
